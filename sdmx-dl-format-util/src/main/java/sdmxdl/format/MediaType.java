...
public class MediaType {
    ...
    public static final MediaType XML_TYPE = builder().type("application").subtype("xml").build();
    public static final MediaType JSON_TYPE = builder().type("application").subtype("json").build();
    public static final MediaType CSV_TYPE = builder().type("text").subtype("csv").build();
    public static final MediaType ZIP_TYPE = builder().type("application").subtype("zip").build();
