...
public class ImfDialectDriverTest {
    ...
    public void testProperties() {
        assertThat(new ImfDialectDriver().getDriverPropertyNames())
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "ImfDialectDriverTest.csv", useHeadersInDisplayName = true)
    @Tag("webQueries")
    public void testBuiltinSources(String source, String flow, String key, int minFlowCount, int dimCount, int minSeriesCount, int minObsCount, String details) throws IOException {
        DriverAssert.assertBuiltinSource(new ImfDialectDriver(), DriverAssert.SourceQuery
                        .builder()
                        .source(source)
