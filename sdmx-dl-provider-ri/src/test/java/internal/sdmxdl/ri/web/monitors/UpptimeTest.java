...
public class UpptimeTest {
    ...
    public void testGetReport() {
        assertThat(Upptime.getReport(UpptimeSummary.of("ABS", "up", "100.00%", 4674)))
                .isEqualTo(SdmxWebMonitorReport.builder().source("ABS").status(SdmxWebStatus.UP).uptimeRatio(1d).averageResponseTime(4674L).build());

        assertThat(Upptime.getReport(UpptimeSummary.of("ILO", "down", "20.97%", 14989)))
        ...
        assertThat(Upptime.getReport(UpptimeSummary.of("ILO", "down", "X", -1)))
