...
public class KeyRequest {
    ...
    @StaticFactoryMethod
    public static @NonNull KeyRequest parse(@NonNull URI uri) {
    ...
    public @NonNull URI toURI() {
        String result = URIs.SDMX_DL_SCHEME + ":/" + URIs.encode(source) + "/" + URIs.encode(flow.toString()) + "/" + URIs.encode(key.toString());
