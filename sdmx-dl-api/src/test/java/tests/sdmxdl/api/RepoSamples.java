...
public class RepoSamples {
    ...
    public static final Codelist CL1 =
            Codelist.builder().ref(CL_REF1).code("M", "Monthly").build();
    public static final Codelist CL2 = Codelist.builder()
            .ref(CL_REF2)
            .code("BE", "Belgium")
            .code("FR", "France")
            .build();
    public static final Codelist CL3 = Codelist.builder()
            .ref(CL_REF3)
            .code("INDUSTRY", "Industry")
            .code("XXX", "Other")
            .build();
    public static final Codelist CL4 =
            Codelist.builder().ref(CL_REF4).code("A", "Normal value").build();

    public static final Dimension DIM1 = Dimension.builder()
            .id("FREQ")
            .codelist(CL1)
            .name("Frequency")
            .index(0)
            .build();
    public static final Dimension DIM2 = Dimension.builder()
            .id("REGION")
            .codelist(CL2)
            .name("Region")
            .index(1)
            .build();
    public static final Dimension DIM3 = Dimension.builder()
            .id("SECTOR")
            .codelist(CL3)
            .name("Sector")
            .index(2)
    ...
    public static final Attribute NOT_CODED_ATTRIBUTE = Attribute.builder()
            .id("TITLE")
            .name("Title")
            .relationship(AttributeRelationship.SERIES)
            .build();
    public static final Attribute CODED_ATTRIBUTE = Attribute.builder()
            .id("OBS_STATUS")
            .codelist(CL4)
    ...
    public static final Structure STRUCT = Structure.builder()
            .ref(STRUCT_REF)
            .dimension(DIM1)
            .dimension(DIM2)
            .dimension(DIM3)
    ...
    public static final MetaSet META_SET =
            MetaSet.builder().flow(FLOW).structure(STRUCT).build();

    public static final Obs OBS1 =
            Obs.builder().period(periodOf(2010, 1)).value(Math.PI).build();
    public static final Obs OBS2 =
            Obs.builder().period(periodOf(2010, 2)).value(Math.E).build();
    ...
    public static final Series S1 = Series.builder()
            .key(K1)
            .obs(OBS1)
            .obs(OBS2)
    ...
    public static final Series S2 = Series.builder().key(K2).build();

    public static final Series S3 = Series.builder().key(K3).obs(OBS1).build();

    public static final DataSet DATA_SET =
            DataSet.builder().ref(FLOW_REF).series(S1).series(S2).series(S3).build();
    ...
    public static final DataRepository REPO = DataRepository.builder()
            .name("repoName")
            .database(DATABASE)
            .structure(STRUCT)
            .flow(FLOW)
    ...
    public static final MonitorReports EMPTY_REPORTS =
            MonitorReports.builder().uriScheme("abc").build();

    public static final MonitorReports REPORTS = MonitorReports.builder()
            .uriScheme("abc")
            .report(MonitorReport.builder()
                    .source("xyz")
                    .status(MonitorStatus.DOWN)
                    .uptimeRatio(0.5)
                    .averageResponseTime(1234L)
                    .build())
            .build();

    public static final WebSource BASIC_SOURCE = WebSource.builder()
            .id("ECB")
            .driver("ri:sdmx21")
            .endpointOf("https://data-api.ecb.europa.eu/service")
            .build();

    public static final WebSource FULL_SOURCE = WebSource.builder()
            .id("ECB")
